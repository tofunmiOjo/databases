<html>
<head><title>First Choice - Query of Employee</title></head>
<h1 style="color:white; text-align: center;font-size:30;">First Choice - Employees information</h1>
...
echo "<form action=\"multiq.php\" method=post>";
   ...
   {
      echo "Employee ID: <select name=\"idnumber\">";
...
echo "<option value='$val[idnumber]'>$val[idnumber]</option>";
   ...
   {
      echo "<p>There are no employees with this ID number!</p>";
   }
