<html>
<head><title>First Choice - Query of Game</title></head>
<h1 style="color:white; text-align: center;font-size:30;">First Choice - Game Score</h1>
...
echo "<form action=\"listScore.php\" method=post>";
